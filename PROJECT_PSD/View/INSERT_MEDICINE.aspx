<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="INSERT_MEDICINE.aspx.cs" Inherits="PROJECT_PSD.View.INSERT_MEDICINE" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <br />
        <div>
            <asp:Button ID="insertBtn" runat="server" Text="INSERT MEDICINE" OnClick="insertBtn_Click" />
        </div>
        <div>
